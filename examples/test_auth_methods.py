...
def test_api_auth():
    """测试方式 2: API Key + Secret"""
    print_section("测试 2: API Key + Secret 认证")
...
def main():
    ...
    results = {
        "钱包地址 + 私钥": "✅ 通过" if wallet_client else "⚠️  未测试",
        "API Key + Secret": "✅ 通过" if api_client else "⚠️  未测试",
    ...
    print("\n推荐使用方式:")
    print("  1. 交易操作: 钱包地址 + 私钥")
    print("  2. API 集成: API Key + Secret")
    print("  3. 数据查询: 只读模式")
    ...
    print("")
    print("  # 方式 2: API 认证")
    print("  HYPERLIQUID_API_KEY=your_api_key")
    print("  HYPERLIQUID_API_SECRET=your_api_secret")
